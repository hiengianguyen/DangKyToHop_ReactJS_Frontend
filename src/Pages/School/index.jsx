    ...
    <div className={cx("wrapper")}>
      <div className={cx("content-1")}>
        ...
        >
          ...
          <p>
            Trường Trung học phổ thông (THPT) Duy Tân là một cơ sở giáo dục công lập tọa lạc tại Phường Quảng Phú, TP. Đà Nẵng. Được thành
            lập vào năm 2010 theo Quyết định số 1119/QĐ-UBND của UBND tỉnh Quảng Nam (cũ), trường nhằm tạo điều kiện thuận lợi cho việc học
            tập của học sinh tại các xã phường như: Phường Quảng Phú, phường Tam Kỳ, phường Hương Trà, phường Bàn Thạch, xã Thăng Trường, xã
            Tam Xuân.
          </p>
        </BoxContentAndImg>
      </div>
      ...
      <div className={cx("content-4")}>
        <Container>
          <div className={cx("main-content")}>
            ...
            <p>
              Bên cạnh việc học tập, Trường THPT Duy Tân luôn chú trọng phát triển toàn diện cho học sinh thông qua nhiều hoạt động ngoại
              khóa phong phú như: hội trại truyền thống, câu lạc bộ học thuật, thể thao, văn nghệ và các chương trình thiện nguyện ý nghĩa.
              Những sân chơi này không chỉ giúp học sinh thư giãn mà còn rèn luyện kỹ năng sống, tinh thần đồng đội và sự tự tin.
            </p>
        ...
        >
          ...
          <p>
            ...
            chương trình biểu diễn như Hội diễn chào mừng năm học mới, Văn nghệ tri ân thầy cô 20/11, và Tết xuân yêu thương. Các tiết mục
            do chính học sinh biên tập và thể hiện, từ múa, hát, nhạc kịch đến biểu diễn nhạc cụ dân tộc và hiện đại.
          </p>
        </BoxContentAndImg>
        ...
        >
          ...
          <p>
            ...
            Được tổ chức vào những dịp đặc biệt như kỷ niệm thành lập trường, Ngày Thành lập Đoàn 26/3 hoặc các sự kiện trọng đại, hội trại
            là cơ hội để học sinh được hòa mình vào không khí sôi động với các hoạt động: dựng trại theo chủ đề, trò chơi dân gian, nét đẹp
            doàn viên và đêm lửa trại đầy cảm xúc.
          </p>
        </BoxContentAndImg>
        ...
        >
          ...
          <p>
            Ngoài văn nghệ và hội trại, Trường THPT Duy Tân còn tổ chức nhiều hoạt động ngoại khóa đa dạng nhằm phát triển kỹ năng mềm và
            nuôi dưỡng tinh thần trách nhiệm trong học sinh. Các chương trình tiêu biểu có thể kể đến như: các câu lạc bộ học thuật – thể
            thao, cuộc thi hùng biện, sáng tạo khoa học, các buổi sinh hoạt chuyên đề kỹ năng sống, và các chương trình thiện nguyện vì cộng
            đồng.
          </p>
        </BoxContentAndImg>
      </div>
      ...
      <div className={cx("box-content-5")}>
        <div className={cx("container")}>
          <div className={cx("content")}>
            ...
            <p>
              Với những nỗ lực không ngừng trong việc nâng cao chất lượng giáo dục và phát triển toàn diện cho học sinh, Trường THPT Duy Tân
              đã trở thành một trong những trường THPT có uy tín.
            </p>
          </div>
          <p>Tìm hiểu thêm về trường học tại:</p>
          <div className={cx("list_link", "mb-4")}>
            <a className={cx("btn-sm")} target="_blank" rel="noreferrer" href="http://thptduytan.edu.vn/index.php/trang-ch/gii-thiu-v-trng">
            ...
            <a className={cx("btn-sm")} target="_blank" rel="noreferrer" href="http://thptduytan.edu.vn/index.php/c-cu-t-chc/ban-giam-hiu">
              Ban giám hiệu
            </a>
            <a
              className={cx("btn-sm")}

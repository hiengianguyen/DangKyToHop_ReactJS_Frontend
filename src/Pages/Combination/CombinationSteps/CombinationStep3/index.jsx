...
function CombinationStep3({
  ...
  const handleChangeCombination = (value, combination) => {
    ...
    if (combination === 1) {
      setCombination2(() =>
        combinations.filter((item) => item.value !== value)
      );
    } else {
      setCombination1(() =>
        combinations.filter((item) => item.value !== value)
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <div
        className={cx("card-body", "container shadow")}
        style={{ fontSize: "17px" }}
      >
        <div className={cx("content", "first")}>
          ...
          <ol className={cx("list-info")}>
            <li>
              Căn cứ lựa chọn môn học: phù hợp với năng lực học tập, sở thích,
              định hướng thi tốt nghiệp, xét tuyển đại học và nghề nghiệp trong
              tương lai.
            </li>
            <li>
              {" "}
              Môn đã chọn sẽ học cả 3 năm học, xác định là không thay đổi.
            </li>
            <li>
              Đăng ký tối đa 02 nguyện vọng. Nhà trường ưu tiên xếp lớp cho
              nguyện vọng 1 trước; trường hợp cần thiết sẽ xếp theo nguyện vọng
              2 để đảm bảo số lớp và phù hợp với tình hình đội ngũ, cơ sở vật
              chất, trang thiết bị dạy học hiện có.
            </li>
            <li>
              Nhà trường ưu tiên dạy học môn thể thao được phụ huynh và học sinh
              lựa chọn, tuy nhiên trong trường hợp cần thiết sẽ tổ chức dạy học
              môn khác trong số các môn còn lại để đảm bảo biên chế lớp, phù hợp
              với tình hình đội ngũ, cơ sở vật chất, trang thiết bị dạy học hiện
              có. Học sinh có năng khiếu ở môn thể thao khác (như võ Karate, võ
              cổ truyền,… có thể tham gia câu lạc bộ năng khiếu).
            </li>
            <li>
              {" "}
              Nhà trường sẽ tổ chức họp phụ huynh và học sinh để tư vấn, hướng
              dẫn; do vậy phụ huynh đăng ký sau khi được tư vấn.
            </li>
          </ol>
          ...
          <div className="my-4 text-center">
            <i className="fs-3">
              <b>Ghi chú:</b> còn rất nhiều tổ hợp xét tuyển ĐH và ngành nghề
              khác gắn với môn học bắt buộc và môn học lựa chọn, bảng trên chỉ
              có tính chất tham khảo, định hướng.
            </i>
          </div>
        </div>
      </div>
          ...
          <div className={cx("content")}>
            ...
            <div className="container">
              ...
              <div className={cx("table-point", "mt-4")}>
                <span className="mb-4">
                  Điểm thi tuyển vào lớp 10 và kết quả học tập, rèn luyện 4 năm
                  THCS của học sinh
                </span>
              ...
              <div className={cx("info-box")}>
                ...
                <ol>
                  ...
                  <p>
                    {" "}
                    Toán, Ngữ văn, Tiếng Anh, Lịch sử, GDTC, GDQP-AN, Giáo dục
                    địa phương, Hoạt động trải nghiệm – hướng nghiệp.
                  </p>
                  <li>Môn học lựa chọn và chuyên đề học tập lựa chọn</li>
                  <ul>
                    <li>
                      Chọn đủ <b>04</b> môn trong số 07 môn học sau: Vật lý, Hóa
                      học, Sinh học (nhóm KHTN), Địa lý, Giáo dục kinh tế và
                      pháp luật (viết tắt là GDKTPL) (nhóm KHXH), Công nghệ, Tin
                      học.
                    </li>
                    <li>
                      Cụm 03 chuyên đề lựa chọn kèm theo tổ hợp môn học lựa
                      chọn.
                    </li>
                    <li>
                      01 môn thể thao trong số các môn: Bóng đá, Bóng chuyền, Đá
                      cầu.
                    </li>
                  </ul>
                </ol>
                  ...
                  <Row>
                    <Col>
                      <Select
                        ...
                        onChange={(e) =>
                          handleChangeCombination(e.target.value, 1)
                        }
                        opts={combination1}
                      />
                    </Col>
                    <Col>
                      <Select
                        ...
                        onChange={(e) =>
                          handleChangeCombination(e.target.value, 2)
                        }
                        opts={combination2}
                      />
                    </Col>

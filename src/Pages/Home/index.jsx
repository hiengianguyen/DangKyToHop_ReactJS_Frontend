  ...
  return (
    <div className={cx("containers", "wrapper")}>
      ...
      <div className={cx("container-start")}>
        <p className={cx("text-center", "fw-bold")}>
      ...
      >
        <div className={cx("content-box", "position-relative", "content-end")}>
          ...
          <p>
            Chúng tôi tin rằng mỗi học sinh là một hạt giống tiềm năng – chỉ cần
            được gieo trồng đúng nơi, sẽ có cơ hội phát triển mạnh mẽ. Hãy để
            ngôi trường này trở thành nơi bắt đầu cho hành trình trưởng thành và
            thành công của bạn.
          </p>

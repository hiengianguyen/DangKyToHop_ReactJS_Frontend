  ...
  useEffect(() => {
    setMenuRoutes(
      mainRouters.filter((route) => {
        return route.inSidebar !== false && route.roles.includes(auth?.user?.role);
      })
    );
    ...
    <div className={cx("d-flex flex-column", "wrapper")}>
      <div className={cx("header")}>
        <div className={cx("d-flex", "align-items-center", "item-header")}>
          ...
          <div className={cx("nav-bar-icon", "main") + " d-flex justify-content-center align-items-center"}>
            <button onClick={handleLogout} title="Đăng xuất">
              <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  fill="#29a9ef"
                />
                <path d="M13.9999 11C14.5522 11 14.9999 11.4477 14.9999 12C14.9999 12.5523 14.5522 13 13.9999 13V11Z" fill="#29a9ef" />
                <path
